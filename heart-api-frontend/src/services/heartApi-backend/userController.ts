...
/** generateAkSk GET /api/user/generateAkSk */
export async function generateAkSkUsingGET(options?: { [key: string]: any }) {
  return request<API.BaseResponseUserAkSkVO>('/api/user/generateAkSk', {
    method: 'GET',
    ...(options || {}),
  });
}
